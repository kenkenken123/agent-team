...
for %%p in (5501 5502 5503 5505) do (
...
rem --- Starting SaaS Frontend ---
powershell -WindowStyle Hidden -Command "Start-Process -FilePath 'npm' -ArgumentList 'run', 'dev' -WorkingDirectory 'saas-frontend' -WindowStyle Hidden"
