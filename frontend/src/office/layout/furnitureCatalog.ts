...
// 鈹€鈹€ Rotation groups 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
// Flexible rotation: supports 2+ orientations (not just all 4)
interface RotationGroup {
  /** Ordered list of orientations available for this group */
  orientations: string[];
  /** Maps orientation 鈫?asset ID (for the default/off state) */
  members: Record<string, string>;
}

// Maps any member asset ID 鈫?its rotation group
const rotationGroups = new Map<string, RotationGroup>();

// 鈹€鈹€ State groups 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
// Maps asset ID 鈫?its on/off counterpart (symmetric for toggle)
const stateGroups = new Map<string, string>();
// Directional maps for getOnStateType / getOffStateType
const offToOn = new Map<string, string>(); // off asset 鈫?on asset
const onToOff = new Map<string, string>(); // on asset 鈫?off asset

// 鈹€鈹€ Animation groups 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
// Maps animation group ID 鈫?ordered list of asset IDs by frame index
...
export function buildDynamicCatalog(assets: LoadedAssetData): boolean {
  ...
  const groupMap = new Map<string, Map<string, string>>(); // groupId 鈫?(orientation 鈫?assetId)
  for (const asset of assets.catalog) {
  ...
  const rotationSchemes = new Map<string, string>(); // groupId 鈫?rotationScheme
  for (const asset of assets.catalog) {
  ...
  // Phase 3: Build state groups (on 鈫?off pairs within same groupId + orientation)
  const stateMap = new Map<string, Map<string, string>>(); // "groupId|orientation" 鈫?(state 鈫?assetId)
  for (const asset of assets.catalog) {
  ...
  // Store full internal catalog (all variants 鈥?for getCatalogEntry lookups)
  ...
  console.log(
    `鉁?Built dynamic catalog with ${allEntries.length} assets (${visibleEntries.length} visible, ${rotGroupCount} rotation groups, ${stateGroups.size / 2} state pairs, ${animGroupCount} animation groups)`,
  );
  return true;
}
...
// 鈹€鈹€ Rotation helpers 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
/** Returns the toggled state variant (on鈫攐ff), or null if no state variant exists. */
