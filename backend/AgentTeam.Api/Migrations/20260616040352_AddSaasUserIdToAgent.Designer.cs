...
namespace AgentTeam.Api.Migrations
{
    ...
    [Migration("20260616040352_AddSaasUserIdToAgent")]
    partial class AddSaasUserIdToAgent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentTeam.Api.Models.AgentGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AgentTeam.Api.Models.FileUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AgentTeam.Api.Models.LongTermMemory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AgentTeam.Api.Models.TaskStats", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AgentTeam.Api.Models.Agent", b =>
                {
                    b.HasOne("AgentTeam.Api.Models.AgentGroup", "Group")
                        .WithMany("Agents")
